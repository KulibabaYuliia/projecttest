export function createMarkup({ drinkThumb, drink, description, _id }) {
  let markup = `<li class="cardlist-item" data-id=${_id}>
        <img src="${drinkThumb}" class="cardlist-img" alt="${drink}" onerror="this.onerror=null;this.src='https://github.com/KaterynaZhuvak/Drinkify/blob/main/src/img/rafiki.jpg';" width=300>
